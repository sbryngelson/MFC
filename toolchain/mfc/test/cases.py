    ...
    def chemistry_cases():
        ...
        stack.push(
            "1D -> Chemistry -> Dual Isothermal Wall Gradient",
            {
                ...
                "bc%x%isothermal_in": "T",
                "bc%x%Twall_in": 600.0,
                "bc%x%isothermal_out": "T",
                "bc%x%Twall_out": 900.0,
                "weno_order": 5,
                "weno_eps": 1e-16,
                "mapped_weno": "T",
                "mp_weno": "T",
