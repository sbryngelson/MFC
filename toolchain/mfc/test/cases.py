...
def get_bc_mods(bc: int, dimInfo):
    ...
    for dimCmp in dimInfo[0]:
        params.update({f"bc%{dimCmp}%beg": bc, f"bc%{dimCmp}%end": bc})
...
def list_cases() -> typing.List[TestCaseBuilder]:
        ...
        if len(dimInfo[0]) == 1:
            stack.push(
                "",
                {
                    ...
                    "bc%x%beg_side%vel(1)": 1.0,
                    "bc%x%beg_side%vel(2)": 0.0,
                    "bc%x%beg_side%vel(3)": 0.0,
                    "bc%x%end_side%vel(1)": 1.0,
                    "bc%x%end_side%vel(2)": 0.0,
                    "bc%x%end_side%vel(3)": 0.0,
                    "bc%x%beg_side%pres": 1.0,
                    "bc%x%end_side%pres": 1.0,
                    "bc%x%beg_side%alpha(1)": 1.0,
                    "bc%x%beg_side%alpha_rho(1)": 1.0,
                },
            )
            ...
            stack.push(
                "",
                {
                    ...
                    "bc%y%beg": -7,
                    "bc%y%end": -8,
                    "bc%y%beg_side%grcbc": "T",
                    "bc%y%end_side%grcbc": "T",
                    "bc%y%end_side%grcbc_vel": "T",
                    "bc%y%beg_side%vel(1)": 0.0,
                    "bc%y%beg_side%vel(2)": 1.0,
                    "bc%y%beg_side%vel(3)": 0.0,
                    "bc%y%end_side%vel(1)": 0.0,
                    "bc%y%end_side%vel(2)": 1.0,
                    "bc%y%end_side%vel(3)": 0.0,
                    "bc%y%beg_side%pres": 1.0,
                    "bc%y%end_side%pres": 1.0,
                    "bc%y%beg_side%alpha(1)": 1.0,
                    "bc%y%beg_side%alpha_rho(1)": 1.0,
                },
            )
            ...
            stack.push(
                "",
                {
                    ...
                    "bc%z%beg": -7,
                    "bc%z%end": -8,
                    "bc%z%beg_side%grcbc": "T",
                    "bc%z%end_side%grcbc": "T",
                    "bc%z%end_side%grcbc_vel": "T",
                    "bc%z%beg_side%vel(1)": 0.0,
                    "bc%z%beg_side%vel(2)": 0.0,
                    "bc%z%beg_side%vel(3)": 1.0,
                    "bc%z%end_side%vel(1)": 0.0,
                    "bc%z%end_side%vel(2)": 0.0,
                    "bc%z%end_side%vel(3)": 1.0,
                    "bc%z%beg_side%pres": 1.0,
                    "bc%z%end_side%pres": 1.0,
                    "bc%z%beg_side%alpha(1)": 1.0,
                    "bc%z%beg_side%alpha_rho(1)": 1.0,
                },
            )
    ...
    def alter_acoustic_src(dimInfo):
        ...
        if len(dimInfo[0]) == 1:
            ...
            for support in [5, 6]:
                stack.push(f"support={support}", {"acoustic(1)%support": support, "cyl_coord": "T" if support == 6 else "F", "bc%y%beg": -2 if support == 6 else -3})
            ...
            stack.pop()
            cases.append(define_case_d(stack, "support=10", {"acoustic(1)%support": 10, "cyl_coord": "T", "bc%y%beg": -2}))
            stack.pop()
    ...
    def alter_hypoelasticity(dimInfo):
        ...
        for num_fluids in [1, 2]:
            ...
            reflective_params = {"bc%x%beg": -2, "bc%x%end": -2, "bc%y%beg": -2, "bc%y%end": -2}
            if len(dimInfo[0]) == 3:
                reflective_params.update({"bc%z%beg": -2, "bc%z%end": -2})
    ...
    def chemistry_cases():
        ...
        stack.push(
            "1D -> Chemistry -> Dual Isothermal Wall Gradient",
            {
                ...
                "x_domain%beg": 0.0,
                "x_domain%end": 0.05,
                "bc%x%beg": -16,  # Left Isothermal Wall
                "bc%x%end": -16,  # Right Isothermal Wall
                "bc%x%beg_side%isothermal": "T",
                "bc%x%beg_side%T_wall": 600.0,
                "bc%x%end_side%isothermal": "T",
                "bc%x%end_side%T_wall": 900.0,
                "weno_order": 5,
                "weno_eps": 1e-16,
                "mapped_weno": "T",
                "mp_weno": "T",
