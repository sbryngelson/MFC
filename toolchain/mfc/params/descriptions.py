...
DESCRIPTIONS = {
    ...
    "x_stretch%beg": "Start of stretching in negative x-direction",
    "x_stretch%end": "Start of stretching in positive x-direction",
    "y_stretch%beg": "Start of stretching in negative y-direction",
    "y_stretch%end": "Start of stretching in positive y-direction",
    "z_stretch%beg": "Start of stretching in negative z-direction",
    "z_stretch%end": "Start of stretching in positive z-direction",
    ...
    "bf%x%enabled": "Enable body force in x-direction",
    "bf%y%enabled": "Enable body force in y-direction",
    "bf%z%enabled": "Enable body force in z-direction",
    "bf%x%g": "Body force magnitude in x-direction",
    "bf%y%g": "Body force magnitude in y-direction",
    "bf%z%g": "Body force magnitude in z-direction",
    "bf%x%k": "Body force wavenumber in x-direction",
    "bf%y%k": "Body force wavenumber in y-direction",
    "bf%z%k": "Body force wavenumber in z-direction",
    "bf%x%w": "Body force frequency in x-direction",
    "bf%y%w": "Body force frequency in y-direction",
    "bf%z%w": "Body force frequency in z-direction",
    "bf%x%p": "Body force phase in x-direction",
    "bf%y%p": "Body force phase in y-direction",
    "bf%z%p": "Body force phase in z-direction",
    # Output flags
...
PATTERNS = [
    ...
    # bc patterns
    (r"bc%([xyz])%beg_side%vel\((\d+)\)", "Inlet velocity component {1} at {0}-boundary"),
    (r"bc%([xyz])%end_side%vel\((\d+)\)", "Outlet velocity component {1} at {0}-boundary"),
    (r"bc%([xyz])%beg_side%alpha_rho\((\d+)\)", "Inlet partial density of fluid {1} at {0}-boundary"),
    (r"bc%([xyz])%beg_side%alpha\((\d+)\)", "Inlet volume fraction of fluid {1} at {0}-boundary"),
    (r"bc%([xyz])%beg_side%pres", "Inlet pressure at {0}-boundary"),
    (r"bc%([xyz])%end_side%pres", "Outlet pressure at {0}-boundary"),
    (r"bc%([xyz])%beg_side%vel_wall\((\d+)\)", "Wall velocity component {1} at {0}-begin"),
    (r"bc%([xyz])%end_side%vel_wall\((\d+)\)", "Wall velocity component {1} at {0}-end"),
    (r"bc%([xyz])%beg_side%grcbc", "Enable GRCBC at {0}-inlet"),
    (r"bc%([xyz])%end_side%grcbc", "Enable GRCBC at {0}-outlet"),
    (r"bc%([xyz])%end_side%grcbc_vel", "Enable GRCBC velocity at {0}-outlet"),
    (r"bc%([xyz])%beg_side%isothermal", "Enable isothermal wall at {0}-inlet"),
    (r"bc%([xyz])%end_side%isothermal", "Enable isothermal wall at {0}-outlet"),
    (r"bc%([xyz])%beg_side%T_wall", "Wall temperature at {0}-inlet"),
    (r"bc%([xyz])%end_side%T_wall", "Wall temperature at {0}-outlet"),
    # patch_bc patterns
