...
DESCRIPTIONS = {
    ...
    "bf_x%enabled": "Enable body force in x-direction",
    "bf_y%enabled": "Enable body force in y-direction",
    "bf_z%enabled": "Enable body force in z-direction",
    "bf_x%g": "Body force magnitude in x-direction",
    "bf_y%g": "Body force magnitude in y-direction",
    "bf_z%g": "Body force magnitude in z-direction",
    "bf_x%k": "Body force wavenumber in x-direction",
    "bf_y%k": "Body force wavenumber in y-direction",
    "bf_z%k": "Body force wavenumber in z-direction",
    "bf_x%w": "Body force frequency in x-direction",
    "bf_y%w": "Body force frequency in y-direction",
    "bf_z%w": "Body force frequency in z-direction",
    "bf_x%p": "Body force phase in x-direction",
    "bf_y%p": "Body force phase in y-direction",
    "bf_z%p": "Body force phase in z-direction",
    # Output flags
