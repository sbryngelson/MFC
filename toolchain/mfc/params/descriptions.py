...
PATTERNS = [
    ...
    (r"patch_ib\((\d+)\)%kin_offset\((\d+)\)", "Body-frame hinge-to-centroid offset component {1} for IB patch {0}"),
    (r"patch_ib\((\d+)\)%kin_phi0", "Roll amplitude (rad) for IB patch {0} kinematics"),
    (r"patch_ib\((\d+)\)%kin_theta0", "Pitch amplitude (rad) for IB patch {0} kinematics"),
